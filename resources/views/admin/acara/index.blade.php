            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">@lang('admin/event.page-title')</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">Master Data</li>
                                <li class="breadcrumb-item active">@lang('admin/event.page-title')</li>
                            </ol>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title d-flex justify-content-between">
                                <span>@lang('admin/event.table-title')</span>

                                <a id="createButton" href="{{ url('events/create') }}"
                            ...
                            <table id="datatable" class="table datatable nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="30"></th>
                                        <th>@lang('admin/event.table.name')</th>
                                    </tr>
                                </thead>
                                @if (env('AJAX') == false)
                                    <tbody>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a href="{{ url('events/detail', Crypt::encrypt($event->id)) }}"
                                                                class="dropdown-item">
                                                                <i class="mdi mdi-information"></i> @lang('forms.button.details')
                                                            </a>
                                                            <a href="{{ url('events/edit', Crypt::encrypt($event->id)) }}"
                                                                class="dropdown-item text-warning">
                                                                <i class="mdi mdi-pencil"></i> @lang('forms.button.edit')
                                                            </a>
                                                            <form action="{{ url('events/destroy') }}" method="POST">
                                                                @csrf
                                                                @method('delete')
        ...
        $(document).ready(function() {
            ...
            @else
                var dropify = $('.dropify').dropify({
                    messages: {
                        'default': 'Click or drag and drop a image',
