...
@section('content')
    @include('admin.tangible-cultural-heritages.modal.form')
    @include('admin.tangible-cultural-heritages.modal.detail')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">@lang('admin/tangible.page-title')</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">Master Data</li>
                                <li class="breadcrumb-item active">@lang('admin/tangible.page-title')</li>
                            </ol>
                        </div>
