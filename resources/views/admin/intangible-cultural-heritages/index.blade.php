...
@section('content')
    @include('admin.intangible-cultural-heritages.modal.form')
    @include('admin.intangible-cultural-heritages.modal.detail')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">@lang('admin/intangible.page-title')</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">Master Data</li>
                                <li class="breadcrumb-item active">@lang('admin/intangible.page-title')</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title d-flex justify-content-between">
                                <span>@lang('admin/intangible.table-title')</span>

                                <a id="createButton" href="{{ url('intangible-cultural-heritages/create') }}"
                            ...
                            <table id="datatable" class="table datatable dt-responsive nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="30"></th>
                                        <th>@lang('admin/intangible.table.name')</th>
                                    </tr>
                                </thead>
                                @if (env('AJAX') == false)
                                    <tbody>
                                        @foreach ($intangible_cultural_heritages as $intangible_cultural_heritage)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a href="{{ url('intangible-cultural-heritages/detail', Crypt::encrypt($intangible_cultural_heritage->id)) }}"
                                                                class="dropdown-item">
                                                                <i class="mdi mdi-information"></i> @lang('forms.button.details')
                                                            </a>
                                                            <a href="{{ url('intangible-cultural-heritages/edit', Crypt::encrypt($intangible_cultural_heritage->id)) }}"
                                                                class="dropdown-item text-warning">
                                                                <i class="mdi mdi-pencil"></i> @lang('forms.button.edit')
                                                            </a>
                                                            <form
                                                                action="{{ url('intangible-cultural-heritages/destroy') }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('delete')
                                                                <input type="hidden" name="id"
                                                                    value="{{ $intangible_cultural_heritage->id }}">
                                                                <button type="submit"
                                                                    class="dropdown-item text-danger destroy"
                                                                    data-id="{{ $intangible_cultural_heritage->id }}"
                                                ...
                                                <td>{{ $intangible_cultural_heritage->name }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                @endif
